...
class TypewiseTest(unittest.TestCase):
  ...
  def test_infers_breach_as_per_limits(self):
    self.assertTrue(typewise_alert.infer_breach(70, 85, 90) == 'TOO_HIGH')
  ...
  def test_classify_temperature_breachs_for_WRONG_KEY(self):
    self.assertTrue(typewise_alert.classify_temperature_breach('WRONG_KEY') == {"lowerLimit" : 'NA', "upperLimit" : 'NA'})
